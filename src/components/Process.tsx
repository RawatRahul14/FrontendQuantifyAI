            ...
            <div className="container">
                ...
                <div className="grid gap-14 lg:grid-cols-2 lg:items-center">
                        ...
                        {processData.list.map(({icon, text, title}, index) => (
                            <motion.div className="flex flex-col gap-4 md:flex-row lg:gap-7" key={index} variants={variants.staggerContainer} initial="start" whileInView="end" viewport={{ once: true }}>
                                ...
                                <div className="grid gap-2 md:gap-3">
                                    <motion.h3 className="text-xl lg:text-2xl" variants={variants.fadeInLeft}>
                                        {title}
                                    </motion.h3>
                    ...
                    <div className="max-lg:-order-1">
                        <motion.figure variants={variants.fadeInUp} initial="start" whileInView="end" viewport={{ once: true }} className="mx-auto bg-primary rounded-3xl max-w-[580px] overflow-hidden p-8 !pb-0 lg:p-12">
